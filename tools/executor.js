...
import { config, reloadScreeningThresholds, updateConfigValue } from "../config.js";
import fs from "fs";
...
const toolMap = {
  ...
  update_config: (args) => {
    const res = updateConfigValue(args);
    if (res.success && (args.key === "managementIntervalMin" || args.key === "screeningIntervalMin")) {
